...
- **Generación de archivos CSV**: Permite exportar los datos del presupuesto y los gastos a un archivo CSV para su posterior análisis o respaldo.
...
5. **Exportar los datos**: Puedes exportar tu presupuesto y los gastos a un archivo CSV para su análisis o para mantener un registro.
6. **Puedes eliminar la base de datos**: Eliminar la base de datos para empezar con un presupuesto nuevo.

## Contribuciones

Las contribuciones a este proyecto son muy bienvenidas. Si tienes alguna mejora o corrección que quieras proponer, por favor sigue estos pasos:

1. Realiza un fork del repositorio.
2. Crea una nueva rama para tu funcionalidad: `git checkout -b feature/mi-nueva-funcionalidad`.
3. Realiza los cambios necesarios y asegúrate de que todo funcione correctamente.
4. Haz un commit con un mensaje claro: `git commit -m "Agregada nueva funcionalidad"`.
5. Haz un push de tu rama a tu repositorio: `git push origin feature/mi-nueva-funcionalidad`.
6. Abre un pull request explicando los cambios que has realizado.
